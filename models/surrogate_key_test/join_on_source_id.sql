...
self_join as (
    ...
    select 
        ...
        uuid_data.surrogate_key_int,
        uuid_data2.surrogate_key_int as surrogate_key_int2,
    ...
    on uuid_data.source_id = uuid_data2.source_id
    where uuid_data.source_name = 'source1'
