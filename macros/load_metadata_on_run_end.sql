{% macro load_metadata_on_run_end( 
    table='load_results',  
...
{# This macro can be added to dbt_project.yml as a on-run-end hook. 
To do so, add the following line to dbt_project.yml 
 
on-run-end: "{{ load_metadata_on_run_end(table='load_results', schema='myschema_audit', database = 'mydatabase', create_schema = true) }}" 
